...
export interface AdminMediaItem extends MediaItem { originalCaption?: string; aiTitle?: string | null; uploaderName: string; categoryName: string; status: MediaStatus }
